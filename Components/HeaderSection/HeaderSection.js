...
function HeaderSection() {
  ...
  return (
    <header className="py-4 font-Righteous  border-b-2 h-[100px]  w-[230vw] lg:w-[210vw] xl:w-[97vw] ml-4 ">
      <div className="flex  space-x-3 space-y-5 sm:ml-2 md:ml-6 xl:ml-20 items-center justify-between">
